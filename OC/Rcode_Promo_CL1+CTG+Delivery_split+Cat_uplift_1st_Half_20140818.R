...
write.csv(df11,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_1st_Half_20140818/Stage11.csv")
...
write.csv(df22,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_1st_Half_20140818/Stage22.csv")
...
write.csv(df33,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_1st_Half_20140818/Stage33.csv")
...
write.csv(df44,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_1st_Half_20140818/Stage44.csv")
