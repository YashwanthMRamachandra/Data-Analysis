...
df <- data.frame(subset(OCC.Input_Freq,start_week>=201327 & start_week<=201426,names(OCC.Input_Freq)),
 row.names=NULL)
OCC.df_sql <- sqldf("select * from 'OCC.Input_Freq' where start_week>=201327 and start_weeek<=201426")
...
df1 <- sqldf("select df.Frequency_cluster,
  ...
  GROUP BY df.Frequency_cluster")

write.csv(df1,"C:/Yashwanth/OC & C/Reports/20140812/Final Reports_Rcode_Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage1.csv")

df2 <- sqldf("select df.CL1,df.CTG,df.,df.,
  sum(df.PROM_sales) as PROM_sales,
  sum(df.PROM_profit) as PROM_profit,
  sum(df.PROM_LI_BAS) as PROM_LI_BAS,
  sum(df.PROM_LI_SAP) as PROM_LI_SAP,
  ...
  sum(df.PREV_duration) as PREV_duration
  from df1 as df
  GROUP BY df.CL1,df.CTG,df.,df.")

write.csv(df2,"C:/Yashwanth/OC & C/Reports/20140812/Final Reports_Rcode_Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage2.csv")

df3 <- sqldf("select df.CL1,df.CTG,df.,
  sum(df.PROM_sales) as PROM_sales,
  sum(df.PROM_profit) as PROM_profit,
  sum(df.PROM_LI_BAS) as PROM_LI_BAS,
  sum(df.PROM_LI_SAP) as PROM_LI_SAP,
  ...
  sum(df.PREV_duration) as PREV_duration
  from df2 as df
  GROUP BY df.CL1,df.CTG,df.")

write.csv(df3,"C:/Yashwanth/OC & C/Reports/20140812/Final Reports_Rcode_Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage3.csv")

df4 <- sqldf("select df.CL1,df.CTG,
  sum(df.PROM_sales) as PROM_sales,
  sum(df.PROM_profit) as PROM_profit,
  sum(df.PROM_LI_BAS) as PROM_LI_BAS,
  sum(df.PROM_LI_SAP) as PROM_LI_SAP,
...
write.csv(df4,"C:/Yashwanth/OC & C/Reports/20140812/Final Reports_Rcode_Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage4.csv")

df5 <- sqldf("select df.CL1,
  sum(df.PROM_sales) as PROM_sales,
  sum(df.PROM_profit) as PROM_profit,
  sum(df.PROM_LI_BAS) as PROM_LI_BAS,
  sum(df.PROM_LI_SAP) as PROM_LI_SAP,
...
write.csv(df5,"C:/Yashwanth/OC & C/Reports/20140812/Final Reports_Rcode_Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage5.csv")
