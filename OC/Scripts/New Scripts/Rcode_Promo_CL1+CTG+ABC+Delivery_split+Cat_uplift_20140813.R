...
write.csv(df1,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage1.csv")
...
write.csv(df2,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage2.csv")
...
write.csv(df3,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage3.csv")
...
write.csv(df4,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage4.csv")
...
write.csv(df5,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_uplift_20140813/Stage5.csv")
