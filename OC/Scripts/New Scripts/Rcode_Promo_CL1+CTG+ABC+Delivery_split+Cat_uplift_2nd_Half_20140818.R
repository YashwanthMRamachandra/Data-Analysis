...
df1 <- sqldf("select df.CL1,df.CTG,df.CY_ABC,df.Delivery_Flag,df.catman_buy_domain_desc, 
...
write.csv(df1,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_2nd_Half_uplift_20140813/Stage1.csv")

df2 <- sqldf("select df.CL1,df.CTG,df.CY_ABC,df.Delivery_Flag,
             sum(df.PROM_sales) as PROM_sales,
             sum(df.PROM_profit) as PROM_profit,
             sum(df.PROM_LI_BAS) as PROM_LI_BAS,
             sum(df.PROM_LI_SAP) as PROM_LI_SAP,           
...
write.csv(df2,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_2nd_Half_uplift_20140813/Stage2.csv")

df3 <- sqldf("select df.CL1,df.CTG,df.CY_ABC,
             sum(df.PROM_sales) as PROM_sales,
             sum(df.PROM_profit) as PROM_profit,
             sum(df.PROM_LI_BAS) as PROM_LI_BAS,
             sum(df.PROM_LI_SAP) as PROM_LI_SAP,           
...
write.csv(df3,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_2nd_Half_uplift_20140813/Stage3.csv")
...
write.csv(df4,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_2nd_Half_uplift_20140813/Stage4.csv")
...
write.csv(df5,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+ABC+Delivery_split+Cat_2nd_Half_uplift_20140813/Stage5.csv")
