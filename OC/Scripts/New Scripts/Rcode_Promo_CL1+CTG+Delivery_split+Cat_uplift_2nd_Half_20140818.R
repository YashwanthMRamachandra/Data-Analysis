...
df1 <- sqldf("select df.CL1,df.CTG,df.Delivery_Flag,df.catman_buy_domain_desc, 
             ...
             from df where 
             (df.start_week >= 201327 AND df.start_week <= 201352)
             AND df.Main_Leaflet = 'Yes'  
             AND df.occ_filter = 'ok'
             GROUP BY df.CL1,df.CTG,df.Delivery_Flag,df.catman_buy_domain_desc, 
             df.Cat_Ident, df.OCC_cat_group")

write.csv(df1,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_2nd_Half_20140818/Stage1.csv")

df2 <- sqldf("select df.CL1,df.CTG,df.Delivery_Flag,
             sum(df.PROM_sales) as PROM_sales,
             sum(df.PROM_profit) as PROM_profit,
             sum(df.PROM_LI_BAS) as PROM_LI_BAS,
             sum(df.PROM_LI_SAP) as PROM_LI_SAP,           
             ...
             sum(df.after_duration) as after_duration
             from df1 as df 
             GROUP BY df.CL1,df.CTG,df.Delivery_Flag")

write.csv(df2,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_2nd_Half_20140818/Stage2.csv")

df3 <- sqldf("select df.CL1,df.CTG,
             sum(df.PROM_sales) as PROM_sales,
             sum(df.PROM_profit) as PROM_profit,
             sum(df.PROM_LI_BAS) as PROM_LI_BAS,
             sum(df.PROM_LI_SAP) as PROM_LI_SAP,           
...
write.csv(df3,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_2nd_Half_20140818/Stage3.csv")

df4 <- sqldf("select df.CL1,
             sum(df.PROM_sales) as PROM_sales,
             sum(df.PROM_profit) as PROM_profit,
             sum(df.PROM_LI_BAS) as PROM_LI_BAS,
             sum(df.PROM_LI_SAP) as PROM_LI_SAP,           
...
write.csv(df4,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_2nd_Half_20140818/Stage4.csv")
    
    # ---------------------------------------------------------------------------
    
    #----------------------------------------------------------------------------

df11 <- sqldf("select df.CL1,df.CTG,df.Delivery_Flag,df.catman_buy_domain_desc, 
              df.Cat_Ident, df.OCC_cat_group,
              sum(df.PROM_sales) as PROM_sales,
              sum(df.PROM_profit) as PROM_profit,
              sum(df.PROM_LI_BAS) as PROM_LI_BAS,
              ...
              sum(df.after_duration) as after_duration
              from df where 
              (df.start_week >= 201401 AND df.start_week <= 201426)
              AND df.Main_Leaflet = 'Yes'  
              AND df.occ_filter = 'ok'
              GROUP BY df.CL1,df.CTG,df.Delivery_Flag,df.catman_buy_domain_desc, 
              df.Cat_Ident, df.OCC_cat_group")

write.csv(df11,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_2nd_Half_20140818/Stage11.csv")

df22 <- sqldf("select df.CL1,df.CTG,df.Delivery_Flag,
              sum(df.PROM_sales) as PROM_sales,
              sum(df.PROM_profit) as PROM_profit,
              sum(df.PROM_LI_BAS) as PROM_LI_BAS,
              sum(df.PROM_LI_SAP) as PROM_LI_SAP,           
...
write.csv(df22,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_2nd_Half_20140818/Stage22.csv")

df33 <- sqldf("select df.CL1,df.CTG,
              sum(df.PROM_sales) as PROM_sales,
              sum(df.PROM_profit) as PROM_profit,
              sum(df.PROM_LI_BAS) as PROM_LI_BAS,
              sum(df.PROM_LI_SAP) as PROM_LI_SAP,           
...
write.csv(df33,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_2nd_Half_20140818/Stage33.csv")

df44 <- sqldf("select df.CL1,
              sum(df.PROM_sales) as PROM_sales,
              sum(df.PROM_profit) as PROM_profit,
              sum(df.PROM_LI_BAS) as PROM_LI_BAS,
              sum(df.PROM_LI_SAP) as PROM_LI_SAP,           
...
write.csv(df44,"C:/Yashwanth/OC & C/Reports/Promo_CL1+CTG+Delivery_split+Cat_uplift_2nd_Half_20140818/Stage44.csv")
