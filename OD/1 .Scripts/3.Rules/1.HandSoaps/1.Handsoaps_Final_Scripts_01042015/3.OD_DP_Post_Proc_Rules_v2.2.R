...
rm(list=ls())
load("~/OD Dynamic Pricing/OD_DynamicPricing/2.Rules/1.Handsoaps/Optimizer_v2.2.RData")
...
# -----------------------------------------------------------------------------------------------------------------------------------------------#
  ...
  save.xlsx("C:/Yashwanth/Pricing/1.OfficeDepot/10.Rules/1.Rules_data_files/4.Data_v2.2/1.Handsoaps/Handsoaps_Post_Proc2.2.xlsx",
  ...
  write.xlsx(OD.DP_Post_Proc,"C:/Yashwanth/Pricing/1.OfficeDepot/10.Rules/3.Execution/1.Handsoaps/Handsoap_execution_R_v2.2.xlsx",
