...
Review_Aggr_Cleats_Model_Data <- Review_Aggr_Model_Data[Category=="Cleats"]
Review_Aggr_Cleats_Model_Data <- with(Review_Aggr_Cleats_Model_Data,Review_Aggr_Cleats_Model_Data[order(Sales_Units,decreasing = TRUE),])
Review_Aggr_Cleats_Model_Data$Sales <- c(rep(1,50),rep(0,length(51:nrow(Review_Aggr_Cleats_Model_Data))))
Review_Aggr_Cleats_Model_Data <- with(Review_Aggr_Cleats_Model_Data,Review_Aggr_Cleats_Model_Data[order(Product,decreasing = TRUE),])
Review_Aggr_Cleats_Model_Data$Sales <- as.factor(Review_Aggr_Cleats_Model_Data$Sales)
Review_Aggr_Cleats_Model_Data$Product_ID <- as.factor(Review_Aggr_Cleats_Model_Data$Product_ID);str(Review_Aggr_Cleats_Model_Data)
table(Review_Aggr_Cleats_Model_Data$Sales)

#---------------------------------------------------------------------------------------------------------------
#                                        Descriptive Statistics & Correlation
#---------------------------------------------------------------------------------------------------------------

Review_Aggr_Cleats_Model_Data <- data.frame(Review_Aggr_Cleats_Model_Data)
library(psych)
describe(Review_Aggr_Cleats_Model_Data[,sapply(Review_Aggr_Cleats_Model_Data,is.numeric)])

cor(Review_Aggr_Cleats_Model_Data[,sapply(Review_Aggr_Cleats_Model_Data,is.numeric)])
cor(Review_Aggr_Cleats_Model_Data[,sapply(Review_Aggr_Cleats_Model_Data,is.numeric)],use = "na.or.complete")

#---------------------------------------------------------------------------------------------------------------
#                                        Logistic Regression : Baseline
#---------------------------------------------------------------------------------------------------------------

Review_Aggr_Cleats_Model_Data <- data.table(Review_Aggr_Cleats_Model_Data)

# Data Sampling
set.seed(100)
SA_IND  <- sample(nrow(Review_Aggr_Cleats_Model_Data),size=round(((nrow(Review_Aggr_Cleats_Model_Data)/100)*70)+1,0))
SA_TRAIN <- Review_Aggr_Cleats_Model_Data[SA_IND,]
SA_TEST <- Review_Aggr_Cleats_Model_Data[-SA_IND,]
...
# Prediction & Odds ratio
Review_Aggr_Cleats_Model_Data$Prob <-  predict.glm(SA_LR,Review_Aggr_Cleats_Model_Data,type="response")
Review_Aggr_Cleats_Model_Data$Pred_30 <- ifelse(Review_Aggr_Cleats_Model_Data$Prob>0.3,1,0)
Review_Aggr_Cleats_Model_Data$Pred_50 <- ifelse(Review_Aggr_Cleats_Model_Data$Prob>0.5,1,0)
Review_Aggr_Cleats_Model_Data$Odds <- round(Review_Aggr_Cleats_Model_Data$Prob/(1-Review_Aggr_Cleats_Model_Data$Prob),2)
View(exp(cbind(OR = coef(SA_LR), confint(SA_LR))))
...
# 50%
table(Actual=Review_Aggr_Cleats_Model_Data$Sales,Predict=Review_Aggr_Cleats_Model_Data$Pred_50)
Class_Table <- xtable(table(Actual=Review_Aggr_Cleats_Model_Data$Sales,Predict=Review_Aggr_Cleats_Model_Data$Pred_50))
cbind(Class_Table <- xtable(table(Actual=Review_Aggr_Cleats_Model_Data$Sales,Predict=Review_Aggr_Cleats_Model_Data$Pred_50)),
      Per_Correct = c((Class_Table[1,1]/nrow(Review_Aggr_Cleats_Model_Data)*100),(Class_Table[2,2]/nrow(Review_Aggr_Cleats_Model_Data)*100)))
sum(cbind(Class_Table <- xtable(table(Actual=Review_Aggr_Cleats_Model_Data$Sales,Predict=Review_Aggr_Cleats_Model_Data$Pred_50)),
          Per_Correct = c((Class_Table[1,1]/nrow(Review_Aggr_Cleats_Model_Data)*100),(Class_Table[2,2]/nrow(Review_Aggr_Cleats_Model_Data)*100)))[3])
