...
Attribute_Map <- read.csv(file="/home/mono/Documents/Assortment/Top 25/Data/Inputs/Attribute_Map.csv")
Attributes <- read.csv(file="/home/mono/Documents/Assortment/Top 25/Data/Inputs/Attributes.csv")
Quarter_Weights <- read.csv(file="/home/mono/Documents/Assortment/Top 25/Data/Inputs/Quarter_Weights.csv")
#Review_Score_Data <- read.csv(file="/home/mono/Documents/Assortment/Top 25/Data/ProcessedData/2_Review_Score_Data.csv")
...
for(attributeName in attributeList){  # attributeName <- attributeList[1]
  ...
  for(i in colnames(tempDf)[c(4:ncol(tempDf))]){
...
Search_Review_Ration <- Total_Searches/Total_Reviews

Attribute_Map$Net_Search_Score <- Attribute_Map$Search_Score / Search_Review_Ration
...
rm(Attribute_Map)
save(x=Search_Score_Data, file="/home/mono/Documents/Assortment/Top 25/Data/ProcessedData/3_Search_Score_Data.RData")
