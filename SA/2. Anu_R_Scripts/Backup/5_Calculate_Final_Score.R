...
#--- Import data
load(file="/home/mono/Documents/Assortment/Top 25/Data/ProcessedData/2_Review_Rating_Data.RData")
load(file="/home/mono/Documents/Assortment/Top 25/Data/ProcessedData/3_Search_Score_Data.RData")
load(file="/home/mono/Documents/Assortment/Top 25/Data/ProcessedData/4_Social_Signal_Data.RData")
Mapped_Products <- read.csv(file="/home/mono/Documents/Assortment/Top 25/Data/Inputs/Mapped_Products.csv")
Score_Weights <- read.csv(file="/home/mono/Documents/Assortment/Top 25/Data/Inputs/Score_Weights.csv")
...
write.csv(DDI_Data, file="/home/mono/Documents/Assortment/Top 25/Data/ProcessedData/5_Final_DDI.csv", row.names=F)
