...
# --------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------
#                                     Best Seller Prediciton Model : ui.R : reactive
# --------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------
...
shinyUI(fluidPage(
  ...
  titlePanel(title = "Sports Authority : Shoppers Interest Index"), # h4("",align = center)
      ...
      sidebarPanel(# About Sports Authority : help(condtionalPanel)
          ...
          # Models
          conditionalPanel(condition = "$('li.active a').first().html()==='Models'",
                           selectInput('model',"Select the model type", choices = c("Baseline","Revised")))
      ),
