...
setwd("C:/Yashwanth/Clustering/1.Input_data/Data_1.2")
...
write.csv(GAP_Pages_Dist,"C:/Yashwanth/Clustering/2.Distance_Matrix/7.All Group Together/GAP_Pages_Dist_Others_v2.csv")
