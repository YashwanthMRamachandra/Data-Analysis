...
# --------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------
#                                       ||     Subset One : Last three months    ||
# --------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------

Bounce_Rate <- Bounce_Rate[,c(1,42:ncol(Bounce_Rate))]
Avg_Time_On_Page <- Avg_Time_On_Page[,c(1,42:ncol(Avg_Time_On_Page))]
Visits <- Visits[,c(1,42:ncol(Visits))]
Prod_Page_Views <- Prod_Page_Views[,c(1,42:ncol(Prod_Page_Views))]
Page_Views <- Page_Views[,c(1,42:ncol(Page_Views))]
...
Prod_Page_Views_Means <- data.frame(Pages=Prod_Page_Views[,1],Means=rowMeans(Prod_Page_Views[,-1]))
hist(Prod_Page_Views_Means$Means,prob=T,xlab="Product Page Views",main="PPV distribution")
curve(dnorm(x,mean=mean(Prod_Page_Views_Means$Means),sd=sd(Prod_Page_Views_Means$Means)),add=TRUE)
boxplot(Prod_Page_Views_Means$Means)

Page_Views_Means <- data.frame(Pages=Page_Views[,1],Means=rowMeans(Page_Views[,-1]))
hist(Page_Views_Means$Means,prob=T,xlab="Page Views",main="Page Views distribution")
curve(dnorm(x,mean=mean(Page_Views_Means$Means),sd=sd(Page_Views_Means$Means)),add=TRUE)
rm(list=ls(pattern="Means"))

# --------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------
#                                       ||     Subset Two : Last three months    ||
# --------------------------------------------------------------------------------------------------------------
# --------------------------------------------------------------------------------------------------------------

Visits_2 <- data.frame(subset(Visits_Means,Means>0 & Means<100,names(Visits_Means)),
                       row.names=NULL)
Visits_Pages <- Visits_2[1]
Visits_2 <- data.frame(subset(Visits,Pages==Visits_Pages,names(Visits_Pages)),
                       row.names=NULL)

Prod_Page_Views_2 <- data.frame(subset(Prod_Page_Views_Means,Means>0 & Means<30,names(Prod_Page_Views_Means)),
                                row.names=NULL)
...
Page_Views_Mens_Jeans <- data.frame(subset(Page_Views,
                                                Pages=="baggy_fit_jeans" | Pages=="loose_jeans" |
                                                  Pages=="mens_button_fly_jeans" | Pages=="relaxed_fit_jeans" |
                                                  Pages=="mens_low_rise_jeans" | Pages=="mens_slim_fit" |
                                                  Pages=="button_fly_jeans_men" | Pages=="mens_tall_skinny_jeans" |  
...
Prod_Page_Views_Mens_Jeans <- data.frame(subset(Prod_Page_Views,
                                                Pages=="baggy_fit_jeans" | Pages=="loose_jeans" |
                                                  ...
                                                  Pages=="button_fly_jeans_men" | Pages=="mens_tall_skinny_jeans" |  
                                                  Pages=="tall_men_jeans" | Pages=="low_rise_mens_jeans" |
                                                  Pages=="mens_carpenter_jeans" | Pages=="relaxed_jeans",select=names(Prod_Page_Views)),row.names=NULL) 
...
Page_Views_Mens_Jeans <- data.frame(subset(Page_Views,
                                                Pages=="baggy_fit_jeans" | Pages=="loose_jeans" |
                                                  ...
                                                  Pages=="button_fly_jeans_men" | Pages=="mens_tall_skinny_jeans" |  
                                                  Pages=="tall_men_jeans" | Pages=="low_rise_mens_jeans" |
                                                  Pages=="mens_carpenter_jeans" | Pages=="relaxed_jeans",select=names(Page_Views)),row.names=NULL) 
...
#                        as.numeric(rowMeans(Visits_Mens_Jeans[,-1])),
 #                       as.numeric(rowMeans(Prod_Page_Views_Mens_Jeans[,-1])),
#                        as.numeric(rowMeans(Page_Views_Mens_Jeans[,-1])),
                          row.names=NULL)

GAP_Pages_1 <- data.frame(Visits_Mens_Jeans[,1],
                        as.numeric(rowMeans(Visits_Mens_Jeans[,-1])),row.names=NULL)

GAP_Pages_2 <- data.frame(Bounce_Rate_Mens_Jeans[,1],as.numeric(rowMeans(Bounce_Rate_Mens_Jeans[,-1])),
                        as.numeric(rowMeans(Prod_Page_Views_Mens_Jeans[,-1])),row.names=NULL)

names(GAP_Pages) <- c("Pages","Bounce_Rate","Avg_Time_On_Page")#"Visits","Prod_Page_Views","Page_Views"
GAP_Pages <- GAP_Pages_1
...
write.csv(GAP_Pages_Dist,"C:/Yashwanth/Clustering/2.Distance_Matrix/1.Mens Jeans Group One/GAP_Pages_Mens_Jeans_Dist_v2.csv")
...
Prod_Page_Views_Mens_Shirt <- data.frame(subset(Prod_Page_Views,
                                                Pages=="mens_polo" | Pages=="mens_tees" |
                                                  Pages=="deep_v_neck_t_shirts" | Pages=="mens_sweatshirt" |
                                                  Pages=="v_neck_shirts_for_men" | Pages=="funny_t_shirts_for_men" |
                                                  Pages=="mens_fitted_short_sleeve_shirts" | Pages=="denim_shirts_for_men" |  
...
Page_Views_Mens_Shirt <- data.frame(subset(Page_Views,
                                                Pages=="mens_polo" | Pages=="mens_tees" |
                                                  Pages=="deep_v_neck_t_shirts" | Pages=="mens_sweatshirt" |
                                                  Pages=="v_neck_shirts_for_men" | Pages=="funny_t_shirts_for_men" |
                                                  Pages=="mens_fitted_short_sleeve_shirts" | Pages=="denim_shirts_for_men" |  
...
GAP_Pages <- data.frame(Bounce_Rate_Mens_Shirt[,1],as.numeric(rowMeans(Bounce_Rate_Mens_Shirt[,-1])),
                        ...
                        #as.numeric(rowMeans(Visits_Mens_Shirt[,-1])),
                        #as.numeric(rowMeans(Prod_Page_Views_Mens_Shirt[,-1])),
#                        as.numeric(rowMeans(Page_Views_Mens_Shirt[,-1])),
                        row.names=NULL)
names(GAP_Pages) <- c("Pages","Bounce_Rate","Avg_Time_On_Page")#"Page_Views")#"Visits","Prod_Page_Views",
...
colnames(GAP_Pages_Dist) <- GAP_Pages[,1]
rownames(GAP_Pages_Dist) <- GAP_Pages[,1]
write.csv(GAP_Pages_Dist,"C:/Yashwanth/Clustering/2.Distance_Matrix/2.Mens Shirts Group Two/GAP_Pages_Mens_Shirt_Dist_v2.csv")
...
Page_Views_Mens_Jacket <- data.frame(subset(Page_Views,
                                            Pages=="mens_printed_hoodies" | Pages=="mens_wool_coats" |
                                              Pages=="mens_fleece_hoodie" | Pages=="mens_denim_jacket" |
                                              Pages=="mens_jean_jacket" | Pages=="mens_leather_jackets" |
                                              Pages=="sport_jacket" | Pages=="mens_vests" ,select=names(Bounce_Rate)),row.names=NULL) 
...
GAP_Pages <- data.frame(Bounce_Rate_Mens_Jacket[,1],as.numeric(rowMeans(Bounce_Rate_Mens_Jacket[,-1])),
                        ...
                        #as.numeric(rowMeans(Visits_Mens_Jacket[,-1])),
                        #as.numeric(rowMeans(Prod_Page_Views_Mens_Jacket[,-1])),
#                        as.numeric(rowMeans(Page_Views_Mens_Jacket[,-1])),
                        row.names=NULL)
names(GAP_Pages) <- c("Pages","Bounce_Rate","Avg_Time_On_Page")#"Page_Views") # "Visits","Prod_Page_Views",
...
colnames(GAP_Pages_Dist) <- GAP_Pages[,1]
rownames(GAP_Pages_Dist) <- GAP_Pages[,1]
write.csv(GAP_Pages_Dist,"C:/Yashwanth/Clustering/2.Distance_Matrix/3.Mens Jacket Group Three/GAP_Pages_Mens_Jacket_Dist_v2.csv")
...
Page_Views_Mens_Pants <- data.frame(subset(Page_Views,
                                           Pages=="men_jean_leggings" | Pages=="mens_linen_pants" |
                                             Pages=="mens_cargo_pants" | Pages=="mens_sweat_pants" |
                                             Pages=="mens_capri_pants" | Pages=="mens_khakis" |
                                             Pages=="mens_lounge_pants" | Pages=="mens_slim_fit_pants",select=names(Bounce_Rate)),row.names=NULL) 
...
#                        as.numeric(rowMeans(Visits_Mens_Pants[,-1])),
 #                       as.numeric(rowMeans(Prod_Page_Views_Mens_Pants[,-1])),
#                        as.numeric(rowMeans(Page_Views_Mens_Pants[,-1])),
                          row.names=NULL)
names(GAP_Pages) <- c("Pages","Bounce_Rate","Avg_Time_On_Page")# ,"Page_Views")#"Visits","Prod_Page_Views",
...
colnames(GAP_Pages_Dist) <- GAP_Pages[,1]
rownames(GAP_Pages_Dist) <- GAP_Pages[,1]
write.csv(GAP_Pages_Dist,"C:/Yashwanth/Clustering/2.Distance_Matrix/4.Mens Pants Group Four/GAP_Pages_Mens_Pants_Dist_v2.csv")
