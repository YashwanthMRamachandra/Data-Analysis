...
PPV_All_Control <- data.frame(subset(PPV,Pages=="mens_tall_skinny_jeans" | Pages=="relaxed_fit_jeans" |
                                        Pages=="tall_men_jeans" | Pages=="mens_carpenter_jeans" |
                                        Pages=="low_rise_mens_jeans" | Pages=="mens_polo" |
                                        Pages=="deep_v_neck_t_shirts" | Pages=="mens_v_neck" |
                                        Pages=="denim_shirts_for_men" | Pages=="mens_flannel_shirt" |
...
PPV_All_Test <- data.frame(subset(PPV,Pages=="baggy_fit_jeans" | Pages=="loose_jeans" |
                                     Pages=="mens_button_fly_jeans" | Pages=="mens_low_rise_jeans" |
                                     Pages=="button_fly_jeans_men" | Pages=="mens_tees" |
                                     Pages=="mens_fitted_short_sleeve_shirts" | Pages=="mens_sweatshirt" |
                                     Pages=="v_neck_shirts_for_men" | Pages=="funny_t_shirts_for_men" |
...
PPV_All_Control_Means <- cbind(PPV_All_Control,rowMeans(PPV_All_Control[,-1]))
PPV_All_Control_Means <- PPV_All_Control_Means[,c(1,ncol(PPV_All_Control_Means))]
names(PPV_All_Control_Means) <- c("Pages","Control_Means")

PPV_All_Test_Means <- cbind(PPV_All_Test,rowMeans(PPV_All_Test[,-1]))
PPV_All_Test_Means <- PPV_All_Test_Means[,c(1,ncol(PPV_All_Test_Means))]
names(PPV_All_Test_Means) <- c("Pages","Test_Means_one")

PPV_All_Paired <- cbind(PPV_All_Control_Means,PPV_All_Test_Means)
PPV_All_Paired$Diff <- PPV_All_Paired[,2]-PPV_All_Paired[,4]
...
t.test(PPV_All_Paired[,4],PPV_All_Paired[,2],paired=TRUE)
...
PPV_All_Paired$Test_Means_Two <- (PPV_All_Paired$Test_Means_one)+((PPV_All_Paired$Test_Means_one/100)*20)
t.test(PPV_All_Paired[,2],PPV_All_Paired[,6],paired=TRUE)
...
PPV_All_Paired$Test_Means_Three <- (PPV_All_Paired$Test_Means_one)+((PPV_All_Paired$Test_Means_one/100)*235)

t.test(PPV_All_Paired[,2],PPV_All_Paired[,7],paired=TRUE)
